...
const messages: Messages = {
    uz: {
        ...
        telegramLoginSubtitle: 'Telegram orqali kirish',
        telegramLoginHint:
            'Telegram akkauntingiz orqali kiring. Birinchi kirishda akkaunt admin tasdigʻiga yuboriladi.',
        ...
        noComparisonData:
            "Bu ishtirokchilar uchun taqqoslanadigan ma'lumot yo'q",
        ...
        penaltyAdd: "Penalti ballari asosiy o'yin ballariga qo'shiladi.",
    ...
    ru: {
        ...
        telegramLoginSubtitle: 'Вход через Telegram',
        telegramLoginHint:
            'Войдите через аккаунт Telegram. При первом входе аккаунт будет отправлен на одобрение админу.',
        ...
        allOpenMatchesHavePredictions:
            'На всех открытых матчах уже есть прогнозы',
        ...
        nominationRulesClose: 'После начала турнира номинации закрываются.',
